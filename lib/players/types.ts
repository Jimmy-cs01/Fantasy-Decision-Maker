...
export type LeaderSort =
  ...
  | "pass_attempts" | "completions" | "completion_percentage" | "passing_yards" | "passing_air_yards" | "passing_touchdowns" | "interceptions_thrown" | "yards_per_pass_attempt" | "pass_adot" | "passer_rating" | "passing_td_percentage" | "interception_percentage" | "pressure_percentage"
  | "rush_attempts" | "rushing_yards" | "rushing_touchdowns" | "yards_per_carry" | "rushing_td_percentage" | "rush_attempts_red_zone" | "rush_attempts_goal_to_go" | "red_zone_rush_share" | "goal_to_go_rush_share"
  | "targets" | "receptions" | "receiving_yards" | "receiving_touchdowns" | "receiving_air_yards" | "yards_after_catch" | "yards_per_target" | "yards_per_reception" | "receiving_adot" | "yards_after_catch_per_reception" | "receiving_td_percentage";
...
export interface PlayerSeasonRow {
  ...
  times_sacked: number; times_pressured: number; pressure_percentage: number | null;
  ...
  rushing_td_percentage: number | null; red_zone_rush_share: number | null; goal_to_go_rush_share: number | null;
  ...
  yards_after_catch_per_reception: number | null; receiving_td_percentage: number | null;
  offense_snaps: number; team_offense_snaps: number; snap_share: number | null; true_touches: number;
