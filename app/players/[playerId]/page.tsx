...
export default async function PlayerDetailPage({ params, searchParams }: { params: Promise<{ playerId: string }>; searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <div className="mx-auto max-w-6xl">
    ...
    {summary ? <>
      ...
      <p className="mt-4 text-xs text-slate-500">Weekly values come from nflverse. Offensive snap percentage uses nflverse&apos;s PFR-derived snap-count feed when available; missing source weeks remain —.</p>
