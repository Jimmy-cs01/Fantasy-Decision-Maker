...
import { anonymousVisitorType, GUEST_ANALYTICS_SESSION_KEY, GUEST_BROWSER_ID_KEY, getOrCreateAnonymousId, shouldRecordAnalyticsEvent } from "@/lib/analytics/guest";
...
export function AnalyticsTracker() {
  ...
  useEffect(() => {
    ...
    void fetch("/api/analytics/activity", {
      ...
      body: JSON.stringify({ anonymousId, sessionId, path: pathname, visitorType: anonymousVisitorType(pathname) }),
      keepalive: true,
    }).catch(() => undefined);
  }, [pathname]);
  return null;
